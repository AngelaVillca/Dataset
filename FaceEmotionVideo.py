...
prototxtPath = r"C:/Users/gchoq/OneDrive/Escritorio/Firebase/Face_Emotion-master/face_detector/deploy.prototxt"
weightsPath = r"C:/Users/gchoq/OneDrive/Escritorio/Firebase/Face_Emotion-master/face_detector/res10_300x300_ssd_iter_140000.caffemodel"
faceNet = cv2.dnn.readNet(prototxtPath, weightsPath)

# Carga el detector de clasificación de emociones
emotionModel = load_model("C:/Users/gchoq/OneDrive/Escritorio/Firebase/Face_Emotion-master/modelFEC.h5")
...
while True:
    ...
    if cv2.waitKey(1) & 0xFF == ord('q') or (time.time() - tiempo_inicio) >= duracion:
        break

most_detected_emotion = max(emotion_count, key=emotion_count.get)

# Print the most detected emotion
print("The most detected emotion was:", most_detected_emotion)
